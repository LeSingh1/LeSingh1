...
<sub><i>Artwork generated by <a href="./art/build_art.py">art/build_art.py</a> — halftone, hard diagonals, a thirteen-star arc and stripe bars, in Sixers blue and red.<br/>Every glyph is a real vector outline, because GitHub renders these inside <code>&lt;img&gt;</code> and an <code>&lt;img&gt;</code> cannot load a font.</i></sub>
